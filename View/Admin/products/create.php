                ...
                <div class="container-fluid">
                    ...
                    <form method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input name="name" type="text" class="form-control" id="cat" aria-describedby=""
                                placeholder="Enter name">

                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Product price:</label>
                            <input price="price" type="text" class="form-control" id="cat" aria-describedby=""
                                placeholder="Enter price">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Product quantity:</label>
                            <input quantity="quantity" type="text" class="form-control" id="cat" aria-describedby=""
                                placeholder="Enter quantity">

                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Product description:</label>
                            <input images="images" type="text" class="form-control" id="cat" aria-describedby=""
